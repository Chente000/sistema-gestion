# Generated by Django 5.2 on 2025-06-18 07:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('view_proyecto_servicio_social', 'Puede ver proyectos de Servicio Social'), ('add_proyecto_servicio_social', 'Puede añadir proyectos de Servicio Social'), ('change_proyecto_servicio_social', 'Puede modificar proyectos de Servicio Social'), ('delete_proyecto_servicio_social', 'Puede eliminar proyectos de Servicio Social'), ('export_proyecto_servicio_social_pdf', 'Puede exportar proyectos de Servicio Social a PDF'), ('export_proyecto_servicio_social_excel', 'Puede exportar proyectos de Servicio Social a Excel')],
            },
        ),
        migrations.CreateModel(
